                  ...
                  <div className='space-y-3'>
                    {task?.team?.map((m, index) => (
                      ...
                      >
                        <div
                          className={
                            'w-10 h-10 rounded-full text-white flex items-center justify-center text-sm -mr-1 bg-cyan-600'
                          }
                        >
  ...
  const Card = ({ item }) => {
    return (
      <div className='flex space-x-4'>
        ...
        <div className='flex flex-col gap-y-1 mb-8 text-left'>
      ...
      <div className='w-full md:w-1/3'>
        ...
        <div className='w-full flex flex-wrap gap-5'>
          ...
          <textarea
            ...
            placeholder='Type ......'
            className='bg-white w-full mt-10 border border-gray-300 outline-none p-4 rounded-md focus:ring-2 ring-cyan-500'
          ></textarea>
          {isLoading ? (
            <Loading />
          ) : (
